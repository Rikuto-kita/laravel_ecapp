      ...
      <table class="table-auto w-full text-left whitespace-no-wrap">
        <thead>
          <tr>
            ...
            <th class="md:px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">作成日</th></th>
        ...
        @foreach($owners as $owner)
          <tr>
            ...
            <form id="delete_{{$owner->id}}" method='post' action="{{ route('admin.owners.destroy', ['owner'=> $owner -> id])}}">
              ...
              @method('delete')
              <td class="md:px-4 py-3 ">
                <a href="#" data-id="{{ $owner->id }}" onclick="deletePost(this)" class="text-white bg-indigo-400 border-0 py-2 px-4 focus:outline-none hover:bg-indigo-500 rounded">削除</a>
              </td>
            </form>
          </tr>
          @endforeach
